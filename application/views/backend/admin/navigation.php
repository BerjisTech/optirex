    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'show_payment_history'   || $page_name == 'show_bed_allotment'
            ...
            <ul>
                ...
                <li class="hidden <?php if ($page_name == 'show_bed_allotment') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/bed_allotment');?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('bed_allotment'); ?></span>
                    </a>
                </li>
                <li class="hidden <?php if ($page_name == 'show_blood_bank') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/blood_bank');?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('blood_bank'); ?></span>
                    </a>
                </li>
                <li class="hidden <?php if ($page_name == 'show_blood_donor') echo 'active'; ?> ">
                ...
                <li class="hidden <?php if ($page_name == 'show_operation_report') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/operation_report');?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('operation_report'); ?></span>
                    </a>
                </li>
                <li class="hidden <?php if ($page_name == 'show_birth_report') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/birth_report');?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('birth_report'); ?></span>
                    </a>
                </li>
                <li class="hidden <?php if ($page_name == 'show_death_report') echo 'active'; ?> ">
        ...
        <!-- forntend -->
        <li class="hidden <?php if ($page_name == 'frontend') echo 'active'; ?>">
