<?php $stock_category_info = $this->db->get('stock_category')->result_array(); ?>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('pharmacist/stock/create'); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="stock_category_id" class="form-control select2" required>
                                ...
                                <?php foreach ($stock_category_info as $row) { ?>
                                    <option value="<?php echo $row['stock_category_id']; ?>"><?php echo $row['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
