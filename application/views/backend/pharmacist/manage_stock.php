<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_stock');?>');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i> &nbsp;<?php echo get_phrase('add_stock'); ?>
</button>
...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('stock_category'); ?></th>
    ...
    <tbody>
        <?php foreach ($stock_info as $row) { ?>   
            <tr>
                ...
                <td>
                    <?php $name = $this->db->get_where('stock_category' , array('stock_category_id' => $row['stock_category_id'] ))->row()->name;
                        echo $name;?>
                </td>
                ...
                <td>
                    <a  onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_stock/' . $row['stock_id']);?>');" 
                        class="btn btn-default btn-sm">
                        <i class="fa fa-pencil"></i> &nbsp;
                        <?php echo get_phrase('edit');?>
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('pharmacist/stock/delete/' . $row['stock_id']); ?>')"
