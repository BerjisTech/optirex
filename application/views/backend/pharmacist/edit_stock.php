<?php
$stock_category_info = $this->db->get('stock_category')->result_array();
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('pharmacist/stock/update/' . $row['stock_id']); ?>" 
                        ...
                        <div class="form-group">
                            <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('stock_category'); ?></label>

                            <div class="col-sm-7">
                                <select name="stock_category_id" class="form-control select2" required>
                                    <option value=""><?php echo get_phrase('select_stock_category'); ?></option>
                                    <?php foreach ($stock_category_info as $row2) { ?>
                                        <option value="<?php echo $row2['stock_category_id']; ?>" <?php if ($row['stock_category_id'] == $row2['stock_category_id']) echo 'selected'; ?>>
                                            <?php echo $row2['name']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
