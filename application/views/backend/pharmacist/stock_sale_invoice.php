<?php
$edit_data = $this->db->get_where('stock_sale', array('stock_sale_id' => $param2))->result_array();
...
?>
    <div id="invoice_print">
        ...
        <hr>
        <h4><?php echo get_phrase('stocks'); ?></h4>
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <thead>
                <tr>
                    <th class="text-center">#</th>
                    <th width="60%"><?php echo get_phrase('stock_name'); ?></th>
            ...
            <div id="invoice_entry">
                ...
                foreach($stocks as $row2) { ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo $row2->quantity * $stock_info->price; ?>
                        </td>
                    </tr>
                <?php } ?>
            </div>
    ...
    <a class="btn btn-info" href="<?php echo base_url(); ?>payments/pay/<?php echo $param2; ?>/<?php echo $row['total_amount']; ?>">
